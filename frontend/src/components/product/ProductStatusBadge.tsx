...
export function RiskLevelBadge({ riskLevel }: { riskLevel: RiskLevel }) {
  ...
  const colors: Record<string, string> = {
    LOW: "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-800 dark:bg-emerald-950/60 dark:text-emerald-200",
    MEDIUM: "border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-800 dark:bg-amber-950/60 dark:text-amber-200",
